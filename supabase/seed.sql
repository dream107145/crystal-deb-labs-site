...
insert into public.portfolio_projects (title, category, image, description, tech_stack, client, outcomes, screenshots, sort_order, published)
values
  (
  ...
  (
    ...
    array['https://images.unsplash.com/photo-1614680376573-df3480f6c6ff?w=1200'],
    2, true
  )
